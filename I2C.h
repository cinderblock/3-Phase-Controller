...
namespace AVR {
 namespace I2C {
  ...
  enum class Status : u1 {
   ...
   MasterWriteAck = 0x18,
   MasterWriteNack = 0x20,
   MasterDataTransmittedAck = 0x28,
   MasterDataTransmittedNack = 0x30,
   MasterArbitrationLost = 0x38,

   MasterReadAck = 0x40,
   MasterReadNack = 0x48,
   MasterDataReceivedAck = 0x50,
   MasterDataReceivedNack = 0x58,
   
   SlaveWriteAck = 0x60,
   SlaveWriteAckMasterLost = 0x68,
   SlaveGeneralAck = 0x70,
   SlaveGeneralAckMasterLost = 0x78,
   SlaveDataReceivedAck = 0x80,
   SlaveDataReceivedNack = 0x88,
   SlaveGeneralDataReceivedAck = 0x90,
   SlaveGeneralDataReceivedNack = 0x98,
   SlaveStopped = 0xA0,
   
   SlaveReadAck = 0xA8,
   SlaveReadAckMasterLost = 0xB0,
   SlaveDataTransmittedAck = 0xB8,
   SlaveDataTransmittedNack = 0xC0,
   SlaveDataTransmittedAckDone = 0xC8,
